...
const sidebarItems: Array<{ key: string; label: string; prop: keyof Pick<WorkspaceSidebarProps, 'onOpen' | 'onSave' | 'onSkills' | 'onPortals' | 'onExamples' | 'onHelp' | 'onPlanWithAI' | 'onFolder'> }> = [
  ...
  { key: 'plan', label: 'Plan with AI', prop: 'onPlanWithAI' },
];

export default function WorkspaceSidebar({
  onOpen, onSave, onSkills, onPortals, onExamples, onHelp, onPlanWithAI, onFolder, saveDisabled, workspacePath,
}: WorkspaceSidebarProps) {
  const handlers: Record<string, (() => void) | undefined> = {
    onOpen, onSave, onSkills, onPortals, onExamples, onHelp, onPlanWithAI, onFolder,
  };
                ...
                : item.key === 'skills'
                  ...
                  : item.key === 'portals'
                    ...
                    : item.key === 'examples'
                      ...
                      : item.key === 'plan'
                        ? 'bg-accent-lavender/15 text-accent-lavender hover:bg-accent-lavender/25 font-semibold'
